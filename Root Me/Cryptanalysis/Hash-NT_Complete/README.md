...
Link: [Hash-NT](https://www.root-me.org/en/Challenges/Cryptanalysis/Hash-NT) </br>
Hint: Use hashcat </br>
Clue: Rule </br>
...
[*] Cleaning up...
```
Save `b4f79698831d92b61f886438e36c0c52` as hash.txt </br>

## Step 2
Run this following command `hashcat -m 1000 -a 0 hash.txt /usr/share/wordlists/rockyou.txt -r /usr/share/hashcat/rules/rockyou-30000.rule` </br>
