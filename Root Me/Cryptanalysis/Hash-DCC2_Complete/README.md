...
Link: [Hash-DCC2](https://www.root-me.org/en/Challenges/Cryptanalysis/Hash-DCC2) </br>
Hint: Use hashcat </br>
Clue: LOCAL </br>
...
[*] Cleaning up...
```
Save this `$DCC2$10240#Administrator#23d97555681813db79b2ade4b4a6ff25` as hash.txt </br>

## Step 2
Decrypt the hash using Hashcat by run the following command `hashcat -m 2100 hash.txt /usr/share/wordlists/rockyou.txt --force -O` </br>

## Step 3
After the process is completed, you'll get the flag </br>
