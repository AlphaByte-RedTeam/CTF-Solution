...
Link: [Hash-LM](https://www.root-me.org/en/Challenges/Cryptanalysis/Hash-LM) </br>
Hint: Dumping local </br>
Clue: Only one part </br>
...
[*] Cleaning up...
```
Save `d3bf255c530633b9aad3b435b51404ee` as hash.txt </br>

## Step 2
Run this command in you terminal `hashcat -m 3000 hash.txt /usr/share/wordlists/rockyou.txt --force -O` </br>

## Step 3
You'll get the password after the process is completed </br>
